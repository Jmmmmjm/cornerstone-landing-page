    ...
    <section id="solutions" ref={containerRef} className="relative py-24 md:py-32 bg-gradient-noise overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="relative flex flex-col md:flex-row items-stretch justify-center gap-12 md:gap-24">
          ...
          <div 
            ref={leftCardRef}
            className="flex-1 flex flex-col bg-[#112240] border border-[#8892B0]/20 rounded-none p-10 transition-all duration-300 hover:-translate-y-1 hover:border-[#8892B0]/50"
          >
            ...
            <button className="w-full bg-transparent border border-[#8892B0]/50 text-[#F8F9FA] hover:bg-[#F8F9FA] hover:text-[#0A192F] px-6 py-3 text-sm font-medium transition-colors rounded-none">
              See what's included
            </button>
          </div>
          ...
          >
            ...
            <button className="w-full bg-[#F8F9FA] text-[#0A192F] hover:bg-[#8892B0] px-6 py-3 text-sm font-medium transition-colors rounded-none">
