...
/* import { getBusySlots } from '@/scripts/calendar_logic.cjs'; */
...
// Now you can run the same logic as before, but it's 100% automated!
...
/* console.log(getBusySlots("MM-DD-YYYY")); */

// TODO: Fetch real busy slots from Google Calendar freeBusy API
const BUSY_SLOTS: string[] = ['10:00 AM', '2:00 PM'];
...
// Partial interface for the Google Calendar Event resource
...
export function BookingModal({ isOpen, onClose }: BookingModalProps) {
  ...
  return createPortal(
    ...
    >
      <button onClick={() => {console.log(getBusySlots('YYYY-MM-DD'))}}>test</button>
      <div
        ref={containerRef}
