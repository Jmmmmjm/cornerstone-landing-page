    ...
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center pointer-events-none py-4">
      <motion.nav
        ...
        animate={{
          ...
          borderColor: scrolled ? (isDark ? 'rgba(148, 163, 184, 0.1)' : 'rgba(0, 0, 0, 0.1)') : 'transparent',
      ...
      >
        ...
        <div className="flex items-center gap-4 relative z-10">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            href="#pricing"
            className="flex items-center gap-2 font-bold tracking-widest uppercase text-[10px] transition-colors duration-300"
            style={{
